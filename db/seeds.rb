...
bruno = User.create(first_name: "Bruno", last_name: "Coquatrix", category: 'owner', email: "b.coquatrix@olympia.fr", password: 'password123')
...
jm = User.create(first_name: "Jean-Marc", last_name: "Dumontet", category: 'owner', email: "jmd@jmdprod.fr", password: 'password123')
...
sae = User.create(first_name: "SAE", last_name: "POPB", category: 'owner', email: "SAE-Arena-Paris@paris.fr", password: 'password123')
...
puts sae.persisted? ? "SAE has been created" : "SAE creation failed"
...
owner = User.find_by(last_name: "POPB")
